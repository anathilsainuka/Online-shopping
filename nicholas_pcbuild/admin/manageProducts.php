                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <?php
                                while ($pdt = mysqli_fetch_assoc($products)) {
                                ?>
                                    <div class="col-md-4">
                                        <!-- <h5 class="card-title fw-semibold mb-4">Product</h5> -->
                                        <div class="card shadow-lg">
                                            <img style="width: 60%; padding: 10px;" src="img/imgAssets/<?php echo $pdt['pdt_img'] ?>" class="card-img-top" alt="...">
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo $pdt['pdt_name'] ?></h5>
                                                <p>Price : <?php echo $pdt['pdt_price'] . ".LKR" ?></p>
                                                <p>Stock : <?php echo $pdt['pdt_stock'] ?></p>
                                                <p>category :
                                                    <?php if ($pdt['pdt_ctg'] == 1) {
                                                        echo "GPU";
                                                    } elseif ($pdt['pdt_ctg'] == 2) {
                                                        echo "CPU";
                                                    } elseif ($pdt['pdt_ctg'] == 3) {
                                                        echo "Motherboard";
                                                    } elseif ($pdt['pdt_ctg'] == 4) {
                                                        echo "CASE";
                                                    } elseif ($pdt['pdt_ctg'] == 5) {
                                                        echo "Cooling";
                                                    } elseif ($pdt['pdt_ctg'] == 6) {
                                                        echo "Memory";
                                                    } elseif ($pdt['pdt_ctg'] == 7) {
                                                        echo "Storage";
                                                    } elseif ($pdt['pdt_ctg'] == 8) {
                                                        echo "PSU";
                                                    } elseif ($pdt['pdt_ctg'] == 9) {
                                                        echo "FANS";
                                                    } elseif ($pdt['pdt_ctg'] == 10) {
                                                        echo "OS";
                                                    }
                                                    ?>
                                                </p>
                                                <p>Status :
                                                    <?php if ($pdt['pdt_status'] == 1) {
                                                        echo "Published";
                                                    } else {
                                                        echo "Unpublished";
                                                    }
                                                ...
                                                <a href="?productStatus=delete&&id=<?php echo $pdt['pdt_id'] ?>" class="btn btn-danger">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
